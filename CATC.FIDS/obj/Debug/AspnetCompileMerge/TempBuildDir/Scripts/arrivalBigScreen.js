...
/// <reference path="arrivalBigScreen.js" />
///  FOR  arrivalBigScreen
//中英文切换变量
var changed = 0;
//切换时间
var changeTime = 5;
...
var ArrivalBigScreen =
    {
        Init: function () { ArrivalBigScreen.ListInit(); }
    }
ArrivalBigScreen.ListInit = function () {
    ArrivalBigScreen.CreateVideo();
}
ArrivalBigScreen.CreateVideo = function () {
    var tag = "8";
...
ArrivalBigScreen.FillVideo = function (json) {
    var video = $("#" + json.ID);
    video.html("");
...
//页面数据实时改变方法
ArrivalBigScreen.GetDepCheckinsAndGate = function () {
    var url = "/Message/GetArrBaggage";
    var fdids = $("#fdids").val();
